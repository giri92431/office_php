...
$a_email=$_SESSION['ename'];

$join_sql=mysqli_query($con,"SELECT emp.name,emp.phno,emp.salary,emp.department,emp.emp_level,profile.profile_pic,profile.ftype,profile.fname
                                  from emp 
								  inner join profile 
								  on emp.email='$a_email' and profile.email='$a_email'");
...
<html lang="en">
  ...
  <body>
	...
	<a href="logout.php"  class="btn btn-info" style="float:right;">logout</a>
	 <h2>welcome <?php echo strtoupper($fet['name']);echo " "; echo $fet['emp_level'];?></h2>
	...
	<div class="row">
		  <div class="col-sm-6  col-md-4">
			  ...
			  <img  src="<?php if($fet['profile_pic']==NULL)
                         ...
                         ?>"  alt="..." width="150px" height="150px" style="margin:5px;" /><br/>
			
			<a href="emp_profile_edit.php"  class="btn btn-info">Edit profile</a>
		  </div>
